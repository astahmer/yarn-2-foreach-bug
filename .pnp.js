...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "dependencyTreeRoots": [
      {
        "name": "yarn-2-foreach-bug",
        "reference": "workspace:."
      },
      {
        "name": "abc",
        "reference": "workspace:packages/abc"
      },
      {
        "name": "def",
        "reference": "workspace:packages/def"
      },
      {
        "name": "jkl",
        "reference": "workspace:packages/jkl"
      },
      {
        "name": "xyz",
        "reference": "workspace:packages/xyz"
      }
    ],
    "enableTopLevelFallback": true,
    "ignorePatternData": "(^(?:\\.yarn\\/sdks(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)|$))$)",
    "fallbackExclusionList": [
      ["abc", ["workspace:packages/abc"]],
      ["def", ["workspace:packages/def"]],
      ["jkl", ["workspace:packages/jkl"]],
      ["xyz", ["workspace:packages/xyz"]],
      ["yarn-2-foreach-bug", ["workspace:."]]
    ],
    "fallbackPool": [
    ],
    ...
    "packageRegistryData": [
      ...
      ["abc", [
        ["workspace:packages/abc", {
          "packageLocation": "./packages/abc/",
          "packageDependencies": [
            ["abc", "workspace:packages/abc"]
          ],
          "linkType": "SOFT",
      ...
      ["def", [
        ["workspace:packages/def", {
          "packageLocation": "./packages/def/",
          "packageDependencies": [
            ["def", "workspace:packages/def"]
          ],
          "linkType": "SOFT",
      ...
      ["jkl", [
        ["workspace:packages/jkl", {
          "packageLocation": "./packages/jkl/",
          "packageDependencies": [
            ["jkl", "workspace:packages/jkl"]
          ],
          "linkType": "SOFT",
      ...
      ["xyz", [
        ["workspace:packages/xyz", {
          "packageLocation": "./packages/xyz/",
          "packageDependencies": [
            ["xyz", "workspace:packages/xyz"]
          ],
          "linkType": "SOFT",
